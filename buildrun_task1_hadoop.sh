...
$HADOOP_HOME/bin/hdfs dfs -copyFromLocal a2_inputs/sample_input/smalldata.txt $INPUT
time $HADOOP_HOME/bin/yarn jar Task1.jar Task1 -D mapreduce.map.java.opts=-Xmx4g /a2_inputs/in4.txt $OUTPUT
